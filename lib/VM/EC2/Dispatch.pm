...
=head2 VM::EC2::Dispatch->replace($request_name => 'request_ok')
...
If you use a handler named "response_ok", then a true result will be
returned if the AWS request resulted in a "200 OK" response. The body
of the response is not used.
