...
=head2 $object = VM::EC2::Generic->new($payload,$ec2)

Given the parsed XML generated by VM::EC2 and VM::EC2::Dispatch and
the VM::EC2 object, return a new object.
...
Return the VM::EC2 object that generated this object.
