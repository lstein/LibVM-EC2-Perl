...
MyAWS::Object::Volume - Object describing an Amazon EBS volume
...
MyAWS::Object::BlockDevice::Attachment object describing the
...
Returns the MyAWS::Object::Snapshot object that this volume was
...
method will return them as a list of MyAWS::Object::Snapshot objects.
...
sub attachment {
    ...
    return MyAWS::Object::BlockDevice::Attachment->new($id,$self->aws)
}
...
sub attachments {
    ...
    my @a = map {MyAWS::Object::BlockDevice::Attachment->new($_,$self->aws)} @$items;
    return @a;
}
