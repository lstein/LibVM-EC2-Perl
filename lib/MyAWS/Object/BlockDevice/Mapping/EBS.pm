...
MyAWS::Object::BlockDevice::Mapping::EBS - Object describing an EBS volume that has been mapped onto an Amazon EC2 instance

=head1 SYNOPSIS

  use MyAWS;

  my $instance  = $aws->describe_instances(-instance_id=>'i-123456');
...
MyAWS->describe_instances().

It is easy to confuse this with MyAWS::Object::BlockDevice::EBS, which
...
MyAWS::Object::BlockDeviceMapping, it is somewhat simpler to call
...
This returns the MyAWS::Object::Volume object that corresponds to this
